...
import Ads from "react-native-vector-icons/MaterialCommunityIcons";
  ...
  return (
    <View>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.petertext}>Peter Prasad</Text>
      ...
      >
        ...
        >
          <View style={{ display: "flex", flexDirection: "row" }}>
            <Ads name="advertisements" size={20} style={styles.timeIcon} />
            <Text style={styles.navText}>Watch Adds</Text>
          </View>
          <View>
            <Icon name="right" size={20} style={styles.iconLeft} />
          </View>
